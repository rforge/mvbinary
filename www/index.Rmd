...
* *Reference*: [An Extended Family of One-Factor Distributions for Modelling High-Dimensional Binary Data](http://arxiv.org/abs/1511.01343), Marbac, M. and Sedki, M., 2015, preprint.
...
```{r, comment=""}
  ...
  results <- MvBinaryEstim(plants, nbcores = 4)
